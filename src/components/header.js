const Header = () => {
  return (
    <div className="absolute top-[1px] left-[0px] bg-whitesmoke-200 w-[1440px] h-[115px] overflow-hidden flex flex-row items-center justify-center py-[26px] px-16 box-border gap-[550px] text-left text-11xl text-darkolivegreen font-josefin-sans-thin">
